...
public class Example10 {
    public static void main(String[] args) {
        Example10_1 myex1 = new Example10_1();
        Example10_1 myex2 = new Example10_1();
        myex1.calcMaxMin(1,0,-9,5,25,-101);
        myex1.viewMaxMin();
        Example10_1.calcMaxMin(3,0,500,-2,33,-5,6,17);
        Example10_1.viewMaxMin();
        myex2.calcMaxMin(3,0,50,-2,33,-5,6,17);
        myex2.viewMaxMin();
    }
    protected static class Example10_1 {
